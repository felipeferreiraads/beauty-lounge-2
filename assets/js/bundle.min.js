...
var _shufflejs = __webpack_require__(22);
...
var GridShuffle = function () {
    function GridShuffle(element) {
        _classCallCheck(this, GridShuffle);

        this.element = element;
        this.activeFilters = [];
        this.shuffle = new _shufflejs2.default(element, {
    ...
    _createClass(GridShuffle, [{
        ...
        value: function removeActiveFilter() {
